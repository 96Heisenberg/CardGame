...
public class App 
{
	public static void main( String[] args )
	{
		...
		while(packFour.size()>1 ) {
			System.out.println(packOne.get(0));
			pickingOrderedList.add(packOne.get(0));
			packOne.remove(0);

			System.out.println(packTwo.get(0));
			pickingOrderedList.add(packTwo.get(0));
			packTwo.remove(0);

			System.out.println(packThree.get(0));
			pickingOrderedList.add(packThree.get(0));
			packThree.remove(0);

			System.out.println(packFour.get(0));
		...
		finalPack.forEach(System.out::println);
		finalPack.forEach(System.out::println);
